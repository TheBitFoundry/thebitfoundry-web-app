        ...
        <div class="swiper-container no-slider animation slider-h-100">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide-center">
                    <img data-aos="zoom-out-up" data-aos-delay="800" src="../../public/img/Foundry Pixel Art/Clean-Tech-Foundry-www.thebitfoundry.net.png" class="hero-image" alt="Hero Image">
